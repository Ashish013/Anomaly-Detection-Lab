...
def parse_opt():
    ...
    parser.add_argument('--save-crop-vid-path', type=str, default='../detected_videos/', help='path to save predicted cropped video')
